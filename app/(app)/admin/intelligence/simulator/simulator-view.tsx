...
const propertyLabels: Record<string, string> = {
  ...
  room_overview_context_observed: "Raumübersichtskontext",
  indoor_installation_area_observed: "Innenbereichskontext",
  outdoor_installation_area_observed: "Außenbereichskontext",
  line_route_context_observed: "Leitungswegkontext",
