    ...
    <form action={formAction} className="mt-2 space-y-3">
      ...
      <fieldset className="space-y-2">
        ...
        <label className="block rounded border p-3 text-sm">
          <input className="mr-2" type="radio" name="requires_human_review" value="true" defaultChecked={requiresHumanReview === true} required />
          <span className="font-medium">Human Review erforderlich</span>
        </label>
        <label className="block rounded border p-3 text-sm">
          <input className="mr-2" type="radio" name="requires_human_review" value="false" defaultChecked={requiresHumanReview === false} required />
