...
export const TEMPLATE_KEYS = ["ask_room_type", "ask_room_area_approximate", "ask_building_type", "ask_indoor_position_known", "ask_outdoor_position_known", "ask_line_route_known", "ask_electrical_supply_known", "ask_accessibility_known"] as const;
...
export const PLANNER_REASON_CODES = ["missing_for_target", "retry_simplified", "retry_limit_fallback", "contradiction_requires_clarification", "customer_effort_break", "target_reached", "site_check_required", "assumption_available", ...HUMAN_REVIEW_REASONS] as const;
export const INELIGIBILITY_CODES = ["information_already_sufficient", "not_applicable", "retry_limit_reached", "missing_dependency", "customer_cannot_answer", "already_requires_site_check", "assumption_already_active", "not_relevant_for_target", "contradiction_requires_resolution", "stale_state_version", "entity_not_found", "human_takeover_required", "customer_effort_limit_reached", "active_question_pending"] as const;
export const PLANNER_STOP_REASONS = ["target_readiness_reached", "no_eligible_candidate", "customer_declined", "customer_unresponsive", "requires_human_review", "site_visit_required", "critical_contradiction", "collection_paused", "maximum_customer_effort_reached"] as const;
