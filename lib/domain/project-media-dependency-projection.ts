...
export const MEDIA_DEPENDENCY_TYPES = ["evidence_interpretation", "observation_followup", "claim_proposal_review", "claim_apply"] as const;
...
export const MEDIA_DEPENDENCY_MISSING_AUTHORITIES = ["correction", "offer", "execution"] as const;
export const MEDIA_DEPENDENCY_REASON_CODES = [
  ...
  "correction_authority_missing", "offer_authority_missing", "execution_authority_missing",
...
export type DerivedMediaDependency = Readonly<{
  evidence_id: string; dependency_type: DependencyType; source_record_kind: "interpretation_run" | "observation" | "claim_proposal";
...
const reasonForMissing = { correction: "correction_authority_missing", offer: "offer_authority_missing", execution: "execution_authority_missing" } as const;
