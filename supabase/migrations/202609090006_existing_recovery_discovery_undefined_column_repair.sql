-- AP-16-06-06D-10: repair the schema-invalid snapshot text reference in existing-command recovery.
...
comment on function public.discover_recoverable_conversation_cycles(integer) is 'Side-effect-free service-only discovery of ordinary recovery and one eligible exhausted technical rehabilitation; prompt text is validated against immutable rendered snapshot content.';
