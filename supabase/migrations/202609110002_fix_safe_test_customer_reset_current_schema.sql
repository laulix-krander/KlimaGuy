-- AP-16-06-06D-23B: replace the reset with the verified production-schema path.
-- The three isolated AP-16-06-01D customer_answer_knowledge_* relations are not
-- part of the deployed current product authority; project_knowledge_* is.
